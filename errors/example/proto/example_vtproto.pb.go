...
func (m *Error) CloneVT() *Error {
	...
	if rhs := m.Request; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *anypb.Any }); ok {
			...
			r.Request = proto.Clone(rhs).(*anypb.Any)
		}
	}
...
func (this *Error) EqualVT(that *Error) bool {
	...
	if equal, ok := interface{}(this.Request).(interface{ EqualVT(*anypb.Any) bool }); ok {
...
func (c *helloClient) Hello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
	err := c.cc.Invoke(ctx, "/github.com.gostdlib.base.proto.example.Hello/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Hello_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/github.com.gostdlib.base.proto.example.Hello/Hello",
	}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Category |= ErrorCategory(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
