...
// TestCat is a test category used for testing purposes.
type TestCat uint8

const (
	// UnknownCat is an unknown category used for testing purposes.
	UnknownCat TestCat = 0
	// CatReq is a request category used for testing purposes.
	CatReq TestCat = 1
)

// Category returns the string representation of the test category.
...
// TestType is a test type used for testing purposes.
type TestType uint8

const (
	// UnknownType is an unknown type used for testing purposes.
	UnknownType TestType = 0
	// TypeBadRequest is a bad request type used for testing purposes.
	TypeBadRequest TestType = 1
)

// Type returns the string representation of the test type.
